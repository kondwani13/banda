<template>
    <div class="lg:px-6 xl:px-0">
        <div ref="home" class="container mx-auto relative z-20">
            <nav style="background-color:#a8c932;" class="w-full lg:px-16 absolute ">
                <div class="hidden lg:flex w-full f-f-p justify-between items-center py-6 relative">
                    <div class="w-2/3">
                     <img class="w-28" src="https://i.ibb.co/2KWL6sQ/llogo.png" alt="logo" >
                    </div>
                    <div class="md:w-1/2 xl:w-1/3">
                        <ul class="flex justify-between w-full items-center text-white">
                            ...
                            <li class="border-b-4 border-transparent pb-1">
                                <button @click="scrollToAnchorPoint('product')" class="" >Our products</button>
                            </li>
                            <li class="border-b-4 border-transparent pb-1">
                                <button @click="scrollToAnchorPoint('order')" class="" >Order</button>
                            </li>
                            <li class="border-b-4 border-transparent pb-1">
                                <button @click="scrollToAnchorPoint('contact')" class="" >Contact</button>
                            </li>
                            <li class="border-b-4 border-transparent pb-1">
                                <button @click="scrollToAnchorPoint('about')" class="" >About us</button>
                            </li>
                            <li class="border-b-4 border-transparent pb-1">
                                <button @click="scrollToAnchorPoint('faq')" class="" >FAQ</button>
                            </li>
                        </ul>
                    </div>
                </div>
            </nav>
            <nav style="background-color:#a8c932;" class="lg:hidden h-20">
                <div class="flex py-6 justify-between items-center px-4">
                    <div>
                        <img class="w-28 z-50 pb-4" src="https://i.ibb.co/2KWL6sQ/llogo.png" alt="logo" >
                    </div>
    ...
    <div class="pb-20">
      <div style="background-color:#a8c932;" class="">    
          ...
          <div class="mx-auto container w-full flex flex-col justify-center items-center">
            <div class="flex justify-center items-center flex-col">
              <div class="lg:mt-20 mt-9">
                ...
                <h2 class="lg:text-3xl pb-2 text-center md:text-2xl text-2xl font-black leading-10 text-white">Photo studio store</h2>
                
                
                <h2 class="lg:text-6xl md:text-5xl text-3xl font-black leading-10 text-white">Capture life's moments</h2>
              </div>
    ...
    <img class="w-80" src="https://i.ibb.co/P9WfkkR/coll.png" alt="">
    </div>
...
<RouterLink to="/choc">
<img class="w-40" src="https://i.ibb.co/7zWwYvY/canon-5-D-Mark-IV.jpg" alt="choc">
<h2 class="">Canon-5D-Mark-IV</h2>
<p class="">k13,200</p>
</RouterLink>
</div>
<div @click="scrollToAnchorPoint('home')" class="rounded hover:shadow lg:p-10 p-4">
<RouterLink to="/vanila">
<img class="w-40" src="https://i.ibb.co/mhKgzqN/canon-ef-24-105mm.jpg" alt="vanilla">
<h2 class="">Canon-ef-24-105mm</h2>
<p class="">k15,000</p>
</RouterLink>
</div>
<div @click="scrollToAnchorPoint('home')"  class="rounded hover:shadow lg:p-10 p-4">
<RouterLink to="/lem">
<img class="w-40" src="https://i.ibb.co/0nMbJFZ/godox-ad200-pro.png" alt="gen">
<h2 class="">Godox-ad200-pro</h2>
<p class="">k2,400</p>
</RouterLink>
</div>
<div @click="scrollToAnchorPoint('home')" class="rounded hover:shadow lg:p-10 p-4">
<RouterLink to="/strew">
<img class="w-40" src="https://i.ibb.co/HdMck4Z/canon-ef-70-200mm.jpg" alt="Strawberry">
<h2 class="">Canon-ef-70-200mm</h2>
<p class="">k8,400</p>
</RouterLink>
</div>
<div @click="scrollToAnchorPoint('home')" class="rounded hover:shadow lg:p-10 p-4">
<RouterLink to="/velvet">
<img class="w-40" src="https://i.ibb.co/xgKjrV4/Godox-SL150-III.png" alt="velvet">
<h2 class="">Godox-SL150-III</h2>
<p class="">k3,200</p>
</RouterLink>
</div>
<div @click="scrollToAnchorPoint('home')" class="rounded hover:shadow lg:p-10 p-4">
<RouterLink to="/nikon">
<img class="w-40" src="https://i.ibb.co/Lxw9cfb/Nikon-D810.jpg" alt="gen">
<h2 class="">Nikon-D810</h2>
<p class="">k9,000</p>
</RouterLink>
</div>
</div>
...
<faq />
   ...
   <div ref='contact' class="container mx-auto pt-16">
        <div class="lg:flex">
            <div style="background-color:#ffb700;" class="xl:w-2/5 lg:w-2/5 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                <div class="xl:w-5/6 xl:px-0 px-8 mx-auto">
                    ...
                    <div class="flex pb-4 items-center">
                        ...
                        <p class="pl-4 text-white text-base">+260 974 159 881</p>
                    </div>
                    <div class="flex items-center">
                        ...
                        <p class="pl-4 text-white text-base">bandalifegadgetsstore@gmail.com</p>
                    </div>
                    <p class="text-lg text-white pt-10 tracking-wide">
                        Rotana Mall shop #26 off chachacha Rd
                        <br />Lusaka Zambia.
                        .
                    </p>
            ...
            <div style="z-index: 50;" class="relative xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                <form @submit.prevent="sendEmail" class="bg-white py-4 px-8 rounded-tr rounded-br">
                    <h1 style="color:#a8c932;" class="text-4xl font-extrabold mb-6">Enter Details</h1>
                    <div class="block xl:flex w-full flex-wrap justify-between mb-6">
                        <div class="w-2/4 max-w-xs mb-6 xl:mb-0">
                            <div  class="flex flex-col">
                                ...
                                <input name="name" type="text"  v-model="name"  class="focus:outline-none focus:border focus:border-black font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="" />
                            </div>
                        </div>
                        <div style="z-index: 50;" class="w-2/4 max-w-xs xl:flex xl:justify-end">
                            <div  class="flex flex-col">
                                <label class="text-gray-800 text-sm font-semibold leading-tight tracking-normal mb-2">Email</label>
                                <input required name="email" v-model="email" type="email" class="focus:outline-none focus:border focus:border-black font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="" />
                            </div>
                        </div>
                    </div>
                    <div class="flex w-full flex-wrap">
                        <div class="w-2/4 max-w-xs">
                            <div  class="flex flex-col">
                                ...
                                <input name="phone" type="tel" v-model="phone" class="focus:outline-none focus:border focus:border-black font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="" />
                            </div>
                        </div>
                    </div>
                    <div style="z-index: 50;" class="w-full mt-6">
                        <div  class="flex flex-col">
                        ...
                        <button style="background-color:#ffb700;"  type="submit" value="Send" class="focus:outline-none bg-black transition duration-150 ease-in-out hover:bg-yellow-300 rounded text-white px-8 py-3 text-sm leading-6">Submit</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <footer style="background-color:#a8c932;" class="overflow-y-hidden bottom-0 pb-0">
    <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4  py-12">
      <div class="flex flex-col items-center justify-center">
        <div class="flex items-center">
          <img class="w-32" src="https://i.ibb.co/2KWL6sQ/llogo.png" alt="logo" >
        </div>
        <div class="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
          <button  @click="scrollToAnchorPoint('home')" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white">Home</button>
          <button  @click="scrollToAnchorPoint('product')" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white">Product</button>
          <button  @click="scrollToAnchorPoint('order')" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white">Order</button>
          <button  @click="scrollToAnchorPoint('about')" class="focus:underline focus:outline-none hover:text-gray-500 text-base cursor-pointer leading-4 text-white">About</button>
        </div>
        <div class="flex items-center gap-x-8 mt-6">
          <a href="" aria-label="facebook" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
            <svg class="fill-current text-white hover:text-gray-500" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button aria-label="instagram"  class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
            <svg class="fill-current text-white hover:text-gray-500" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button  aria-label="pinterest" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
            <svg class="fill-current text-white hover:text-gray-500" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <div class="flex items-center mt-6">
          <p class="text-base  leading-4 text-white">2023 <span class="font-semibold">Bandalife</span></p>
          <div class="border-l border-white pl-2 ml-2">
            <p class="text-base leading-4 text-white">All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
