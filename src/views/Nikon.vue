        ...
        <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div class="w-full sm:w-96 mt-14 rounded shadow p-4 bg-white md:w-8/12 lg:w-6/12 items-center">
                   <div class="flex">
                    <p class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600  dark:text-white">Gadget / camera / nikon</p>
                    ...
                    <h2 class="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white mt-4">Nikon-D810</h2>
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600  mt-7">The Nikon D810 is a high-end, full-frame DSLR camera designed for professional photographers and advanced enthusiasts. It features a 36.3-megapixel sensor with no optical low-pass filter, which produces stunningly detailed images with excellent color accuracy and dynamic range.</p>
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 dark:text-white">k9,000</p>
                ...
                <div class="w-full -mt-6 sm:w-96 md:w-8/12 lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div class="w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img class="w-40" src="https://i.ibb.co/Lxw9cfb/Nikon-D810.jpg" alt="Wooden Chair Previw" />
                    </div>
                    <div class="w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/Lxw9cfb/Nikon-D810.jpg" alt="Wooden chair - preview 1" />
                        </div>
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/Lxw9cfb/Nikon-D810.jpg" alt="Wooden chair - preview 2" />
                        </div>
