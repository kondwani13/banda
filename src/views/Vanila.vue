            ...
            <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div class="w-full sm:w-96 mt-14 rounded shadow p-4 bg-white md:w-8/12 lg:w-6/12 items-center">
                   <div class="flex">
                    ...
                    <h2 class="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white mt-4">Canon EF 24-105mm</h2>
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600  mt-7">The Canon EF 24-105mm lens is a versatile zoom lens designed for use with Canon EOS cameras. It offers a focal length range of 24-105mm, making it suitable for a wide range of photography applications including landscapes, portraits, and street photography.

The lens features image stabilization technology that helps to reduce camera shake and produce sharper images, particularly in low light situations. It also has a fast, quiet autofocus system that allows for quick and precise focusing.</p>
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 dark:text-white">k15,000</p>
                ...
                <div class="w-full -mt-6 sm:w-96 md:w-8/12 lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div class="w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img class="w-40" src="https://i.ibb.co/mhKgzqN/canon-ef-24-105mm.jpg" alt="shot" />
                    </div>
                    <div class="w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/mhKgzqN/canon-ef-24-105mm.jpg" alt="shot 1" />
                        </div>
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/mhKgzqN/canon-ef-24-105mm.jpg" alt="shot 2" />
                        </div>
